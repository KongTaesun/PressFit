...
public class Community {
 ...
 // 03. 寃뚯떆湲� �긽�꽭�궡�슜 議고쉶, 寃뚯떆湲� 議고쉶�닔 利앷� 泥섎━
    ...
    public ModelAndView update(@ModelAttribute CommunityVO vo) throws Exception{
    	...
    	mav.addObject("dto", communityservice.read(vo.getIdx()));
    	logger.info("mav:", mav);
        return mav;
    }
 // 04. 寃뚯떆湲� �닔�젙
    ...
    public ModelAndView cmt(@ModelAttribute CommunityVO vo) throws Exception{
    	...
    	CommunityVO a = communityservice.read(vo.getIdx());
    ...
    public String updateinsert(@ModelAttribute CommunityVO vo) throws Exception{
