...
public class CLOBHandler implements TypeHandler {
	//Statement로 호출해서 ResultSet의 컬럼이름을 읽어올 때
	@Override
	public Object getResult(ResultSet rs, String columnName) throws SQLException {
		return rs.getString(columnName);
	}
	//Statement로 호출해서 ResultSet의 컬럼인덱스로 읽어올 때
	@Override
	public Object getResult(ResultSet rs, int columnIndex) throws SQLException {
		return rs.getString(columnIndex);
	}
//CallableStatement로 호출해서 ResultSet의 컬럼인덱스로 읽어올 때
	@Override
...
//Statement의 파라미터를 세팅할 때	
	...
	public void setParameter(PreparedStatement ps
			, int columnIndex, Object parameter, JdbcType arg3) throws SQLException {
