...
<script>
    ...
    $("#btnReplyUpdate").click(function(){
        ...
        $.ajax({
            type: "put",
            url: "${path}/gallery/reply/update/${vo.idx}",
    ...
    $("#btnReplyDelete").click(function(){
        if(confirm("삭제하시겠습니까?")){
            $.ajax({
                type: "delete",
                url: "${path}/gallery/reply/delete/${vo.idx}",
                success: function(result){
                    if(result == "success"){
                        alert("삭제되었습니다.");
                        $("#modifyReply").css("visibility", "hidden");
 ...
 // 1_2. 댓글 입력 함수(json방식)
    function replyJsoncmt(){
        ...
        $.ajax({                
            type: "post",
            url: "${path}/gallery/reply/insertRestcmt.do",
            headers: {
                "Content-Type" : "application/json"
            },
            dateType: "text",
    ...
    function listReply(num){
        $.ajax({
            type: "get",
            url: "${path}/gallery/reply/list/${boardno}/"+num,
            success: function(result){
            	console.log(result);
