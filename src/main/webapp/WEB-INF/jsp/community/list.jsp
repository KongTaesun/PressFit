...
<style>
.breadcrumbs-area {
 background-image: url('${path}/resources/writer/img/bigpicture/office_img.png');
}
</style>
		    ...
		    <div class="container">
		        <div class="row">
                   ...
                   <p>${row.idx}</p>                   
                                        ...
                                        <td class="title">
                                            <p>
	  <a href="${path}/community/view.do?idx=${row.idx}&curPage=${map.boardPager.curPage}&searchOption=${map.searchOption}&keyword=${map.keyword}">${row.title} 
        ...
        <br>
        <form name="form1" method="post" action="${path}/community/list.do">
