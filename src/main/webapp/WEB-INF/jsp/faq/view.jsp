...
<script>
    $(document).ready(function(){
        ...
        $("#btnUpdete").click(function(){
        	location.href="${path}/faq/update.do?idx=${dto.idx}";
        });
        $("#btnCmt").click(function(){
        	location.href="${path}/faq/cmt.do?idx=${dto.idx}";
        });
        // 2. 게시글 삭제
        // 삭제 버튼 클릭 
        ...
        $("#btnList").click(function(){
            location.href="${path}/faq/list.do?curPage=${curPage}&searchOption=${searchOption}&keyword=${keyword}";
        });
    ...
    function listAttach(){
        $.ajax({
            type: "post",
            url: "${path}/faq/getAttach/${dto.idx}",
    ...
    function replyJson(){
        ...
        $.ajax({                
            type: "post",
            url: "${path}/faq/reply/insertRest.do",
            headers: {
    ...
    function listReply(num){
        $.ajax({
            type: "get",
            url: "${path}/faq/reply/list/${dto.idx}/"+num,
    ...
    function showReplyCmtModify(num){
        $.ajax({
            type: "get",
            url: "${path}/faq/reply/Cmtdetail/"+num,
            success: function(result){
                $("#modifyReply").html(result);
                $("#modifyReply").css("visibility", "visible");
            }
