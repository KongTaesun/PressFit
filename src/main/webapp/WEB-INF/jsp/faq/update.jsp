...
<script>
    $(document).ready(function(){
        ...
        $("#btnUpdeteinsert").click(function(){
        	...
        	document.form1.action = "${path}/faq/updateinsert.do";
        ...
        $("#fileDrop").on("drop", function(e){
            ...
            $.ajax({
                url: "${path}/faq/upload/uploadAjax",
                type: "post",
                data: formData,
                dataType: "text",
        ...
        $("#uploadedList").on("click", ".fileDel", function(e){
            ...
            $.ajax({
                type: "post",
                url: "${path}/faq/upload/deleteFile",
...
CKEDITOR.replace("content",{
	filebrowserUploadUrl : "${path}/servicecenter/faq/imageUpload.do"
});
</script>
        </div>
        <div>
