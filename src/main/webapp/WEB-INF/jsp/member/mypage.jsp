				...
				<div class="p-details-tab" style="margin-top: 30px;">
					<ul class="p-details-nav-tab">
						<li role="presentation" class="active"><a href="#"
							id="btnone">마이페이지</a></li>
						<li role="presentation"><a
							href="${path}/member/updatepage.do?id=${vo.id}" id="btntwo">내정보관리</a></li>
						<li role="presentation"><a href="${path}/order/orderList.do"
							id="btnthree">내주문관리</a></li>
						<li role="presentation"><a
							href="${path}/order/orderCancel.do" id="btnthree">취소및교환</a></li>
							...
							<div class="about-content">
								...
								<div class="create-account-form">
									<dl class="list_delivery">
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaName" name="id" type="text"
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaEmail" name="pw" type="password"
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaPhone" name="name" type="text"
										...
										<dd>
											<c:choose>
												<c:when test="${ vo.gender eq '0'}">
													<div class="box_input">
														<input class="tf_g" id="oaPhone" name="name" type="text"
															value="남자" readonly="readonly">
													</div>
												</c:when>
												<c:otherwise>
													<div class="box_input">
														<input class="tf_g" id="oaPhone" name="name" type="text"
															value="여자" readonly="readonly">
													</div>
												</c:otherwise>
											</c:choose>
										</dd>
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaPhone" name="birth" type="text"
													value="${vo.birth}" readonly="readonly">
											</div>
										</dd>
										<dt>
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaPhone" name="email"
													value="${vo.email}" type="text" readonly="readonly">
											</div>
										</dd>
										<dt>
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaPhone" name="hp" value="${vo.hp}"
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaPhone" name="address"
													value="${vo.basic_addr} ${vo.detail_addr} ${vo.post}"
													type="text" readonly="readonly">
											</div>
										</dd>
										<dt>
										...
										<dd>
											<div class="box_input">
												<input class="tf_g" id="oaPhone" name="date"
													value="${vo.regdate}" type="text" readonly="readonly">
											</div>
										</dd>
									</dl>
				...
				filebrowserUploadUrl : "${path}/keyboard/imageUpload.do"
									...
									<div style="padding: 30px;">
										...
										<p class="icons animated pulse">
											...
											</a> <a href="https://www.facebook.com/" target="_blank"> <span
												class="fa-stack fa-lg"> <i
													class="fa fa-circle-thin fa-3x fa-stack-2x"></i> <i
													class="fa fa-facebook fa-stack-1x"></i>
											</span>
											</a> <a href="https://google.com/" target="_blank"> <span
												class="fa-stack fa-lg"> <i
													class="fa fa-circle-thin fa-stack-2x"></i> <i
													class="fa fa-google-plus fa-stack-1x"></i>
											</span>
											</a> <a href="https://www.instagram.com/" target="_blank"> <span
												class="fa-stack fa-lg"> <i
													class="fa fa-circle-thin fa-stack-2x"></i> <i
													class="fa fa-instagram fa-stack-1x"></i>
											</span>
											</a> <a href="https://github.com/" target="_blank"> <span
												class="fa-stack fa-lg"> <i
													class="fa fa-circle-thin fa-stack-2x"></i> <i
