											...
											<div class="single-banner" >
												<div class="product-wrapper" style="width:260px; height:260px;">
													...
													<div class="product-description">
														<div class="functional-buttons">
															...
															<a href="${path}/shop/cart/insert.do?price=${row.price}&modelname=${row.modelname}&idx=${row.idx}&amount=1&fullName=${row.fullName}&kind=tmouse" title="Add to Cart"> <i
												...
												<div class="banner-bottom text-center">
													<div class="banner-bottom-title" style="width:100%; height:60px; overflow: hidden; top:50%; margin-top: 15px; margin-bottom: 0px;">
														<a href="${path}/tmouse/view.do?idx=${row.idx}&curPage=${map.boardPager.curPage}&searchOption=${map.searchOption}&keyword=${map.keyword}">${row.modelname} <c:if
																test="${row.recnt >= 0}">
