...
$(document).ready(function(){
	...
	$('#allsearch').animateNumber({
		number: data.allsearch,color: 'black','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
	$('#daysearch').animateNumber({
		number: data.daysearch,color: 'black','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
	$('#two').animateNumber({
		number: 2978 ,color: 'black','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
	},
	error: function(xhr) {
	...
	$('#one').animateNumber({
		number: 100,color: 'green','font-size': '20px',
	...
	$('#wordall').animateNumber({
		number: 74231,color: 'green','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
	$('#productword').animateNumber({
		number: 67,color: 'green','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
	$('#emotionword').animateNumber({
		number: 267,color: 'green','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
	$('#techword').animateNumber({
		number: 7830,color: 'green','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
	$('#designword').animateNumber({
		number: 9126,color: 'green','font-size': '20px',
		easing: 'easeInQuad',numberStep: word
	}, 2000);
