        ...
        $.each(data.list, function(key, value){
            str += 
				"<li><a href='#'>" +
					...
					"<span class='col-md-2'>" + value.regdate +
					"<button onclick='communityBoarddelete("+ value.idx +")'>삭제</button></span> " + 
				"</a>" +
    ...
    if(total == 0){
        ...
        $.each(data.list, function(key, value){
            str += 
				...
				"<span class='col-md-2'>" + value.writer + "</span> " +
				"<span class='col-md-2'>" + value.viewcnt + "</span> " + 
				"<span class='col-md-2'>" + value.regdate + "<button onclick='faqBoarddelete("+ value.idx +")'>삭제</button></span> " + 
			"</a>" +
			"<ul class='faq-content'>" +
				"<li><div><p>" +
					value.content +
...
function changeeditor(){
    var body = $('.write');
    str=
        "<button onclick='writecancel()'>취소</button></span> " + 
        "<button onclick=''>작성</button></span> " + 
        "<h4>제목 " +
...
function writecancel(){
    var body = $('.write');
    str="<button onclick='changeeditor()'>글쓰기</button>"
    body.empty();
    body.append(str);
}
</script>	
						...
						<div id="faq-wrapper" class="about-service">
							<div class="faq-group">
								<div class="slide-left">
									<div class="write"><button onclick="changeeditor()">글쓰기</button></div>
