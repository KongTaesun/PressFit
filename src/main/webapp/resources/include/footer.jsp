...
a {
   ...
   <!-- favicon -->
		...
		<!-- jquery countdown js -->
        <script type="text/javascript" src="${path}/resources/writer/venobox/venobox.min.js"></script>
		<!-- jquery Meanmenu js -->
		...
		<!-- Nivo slider js -->
		<script src="${path}/resources/writer/lib/js/jquery.nivo.slider.js" type="text/javascript"></script>
		<script src="${path}/resources/writer/lib/home.js" type="text/javascript"></script>
		<!-- main js -->
